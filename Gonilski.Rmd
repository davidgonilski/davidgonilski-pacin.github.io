...
<br>
  I am Molecular Biologist PhD Student at the Buenos Aires University (UBA), Argentina working in the [Biomedicine Institute of Buenos Aires](http://ibioba-mpsp-conicet.gov.ar/index.php/en/). I am highly interested in understanding the genetic regulatory networks and molecular signal pathways that drive kidney cancer.

---

## <span style="color:  #63D4FD;"> Research</span>
The main aim of my studies is to understand the mechanisms behind tumorigenesis and improve cancer treatments. Under the guidance of Eduardo Arzt at the Laboratory of Molecular Targeting, I conducted research on the role of RSUME in tumorigenesis, specifically in angiogenesis and vascularization. I focus on the RSUME oncogene's involvement in the development of Von Hippel Lindau tumors. I have analyzed genomic datasets and performed wet lab experiments to support my findings.
...
| Cell Culture | R `r fontawesome::fa("r-project", fill = "gray")` |
| Immunofluorescent Staining | RNA-seq analysis|
| Angiogenesis and Tumorigenesis assays |
